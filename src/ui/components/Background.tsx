...
export default function BackgroundSvg() {
  ...
  return (
    <View style={styles.container} pointerEvents="none">
      {/* Static background */}
      <Svg viewBox="0 0 2000 1500" width="100%" height="100%" style={StyleSheet.absoluteFill}>
        <Rect width="2000" height="1500" fill="#ee5522" />
        <Defs>
        ...
        <G transform="translate(500 375)">
          <Circle r="3000" fill="url(#a)" />
          <G opacity={0.5}>
            {[2000, 1800, 1700, 1651, 1450, 1250, 1175, 900, 750, 500, 380, 250].map(r => (
              <Circle key={r} r={r} fill="url(#a)" />
            ))}
          </G>
        </G>
      </Svg>

      {/* Animated spirals - tam ekran, merkezi 25% 25% */}
      <Animated.View style={[styles.spiralsContainer, animatedStyle]}>
        <Svg viewBox="0 0 2000 1500" width="100%" height="100%">
          <Defs>
      ...
      <Svg viewBox="0 0 2000 1500" width="100%" height="100%" style={StyleSheet.absoluteFill}>
        <Defs>
          <RadialGradient id="a2" gradientUnits="objectBoundingBox">
            <Stop offset="0" stopColor="#FB3" />
            <Stop offset="1" stopColor="#ee5522" />
          </RadialGradient>
        </Defs>
        <G transform="translate(500 375)">
          <Circle r="3000" fill="url(#a2)" fillOpacity={0.11} />
        </G>
      </Svg>
    </View>
  );
